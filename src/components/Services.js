  ...
  return (
    <section className="container max-w-5xl mt-6 pt-4" id="services">
      ...
      <div className="mt-4 grid grid-cols-3 gap-4 md:grid-cols-2 sm:grid-cols-1">
        <div className=" bg-gray-200 dark:bg-neutral-800 dark:text-white p-4 rounded-md">
          <div className="bg-gray-300 dark:bg-neutral-900 p-5 rounded-3xl w-20 h-20">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-full w-full fill-neutral-900 dark:fill-gray-200 block m-auto">
        ...
        <div className=" bg-gray-200 dark:bg-neutral-800 dark:text-white p-4 rounded-md">
          <div className="bg-gray-300 dark:bg-neutral-900 p-5 rounded-3xl w-20 h-20">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="h-full w-full fill-neutral-900 dark:fill-gray-200 block m-auto">
        ...
        {/* <div className=" bg-gray-200 dark:bg-neutral-800 dark:text-white p-4 rounded-md">
          <div className="bg-gray-300 dark:bg-neutral-900 p-5 rounded-3xl w-20 h-20">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="h-full w-full fill-neutral-900 dark:fill-gray-200 block m-auto">
